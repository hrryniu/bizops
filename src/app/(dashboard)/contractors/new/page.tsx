...
export default function NewContractorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Błąd',
        description: 'Nie udało się utworzyć kontrahenta',
        variant: 'destructive',
      })
    } finally {
      setLoading(false)
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Dodaj nowego kontrahenta lub nabywcę</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button type="submit" disabled={loading}>
                {loading ? 'Zapisywanie...' : 'Zapisz kontrahenta'}
              </Button>
              <Button
                type="button"
                variant="outline"
